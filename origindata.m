...
Point_Y1=300;
Point_Z1=400;
Middle_Vector=[0.5 -0.4 1]; %刀轴矢量在加工坐标系中的表示
...
Point_Y2=310;
Point_Z2=400;
Middle_Vector2=[0.55 -0.42 1]; %刀轴矢量在加工坐标系中的表示
...
%计算这两个刀位点之间的关系
Machingposition=MachingPosition(Machinginput1,Machinginput2,MyWorkingMachine);
